...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (x, prev_h, prev_c, Wx, Wh, b, i, f, o, g, next_c, next_h, A)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    x, prev_h, prev_c, Wx, Wh, b, i, f, o, g, next_c, next_h, A = cache
...
def lstm_backward(dh, cache):
    ...
    dperv_h = np.zeros((N, H))
    dperv_c = np.zeros((N, H))

    for t in reversed(range(T)):
      dnext_h = dh[:, t, :] + dperv_h
      dnext_c = dperv_c

      dx[:, t, :], dperv_h, dperv_c, dWx_step, dWh_step, db_step = \
